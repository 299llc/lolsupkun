...
形式:
{"summary":"ビルド選択は適切だったが、デスが多く集団戦での立ち回りに課題あり。序盤の安定感は評価できる。","overall_score":7,"build_score":8,"sections":[{"title":"レーン戦","content":"CS6.5/minで安定。デス2回は改善の余地あり","grade":"B"},{"title":"集団戦・マクロ","content":"キル参加率65%で貢献度高い","grade":"A"}],"good_points":["CSが安定していた","集団戦の位置取りが良かった"],"improve_points":["デスを減らす","ワード設置を増やす"],"next_game_advice":"序盤のデスを1回以内に抑えよう"}`
